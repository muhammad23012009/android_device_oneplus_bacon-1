...
# Kernel
BOARD_KERNEL_CMDLINE := console=tty0 security=apparmor apparmor=1 androidboot.hardware=bacon user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1
